...
export default function CrUxHistoryKeyItem({
  ...
  return (
    <button
      ...
      onBlur={blurHandler}
      // onBlur={focusHandler}
      className={`cursor-pointer bg-transparent rounded hover:bg-gray-100 dark:hover:bg-gray-800 p-1 flex items-center gap-1 border-none  text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-50`}
    >
      <div
